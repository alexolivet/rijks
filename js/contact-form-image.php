	...
	if( empty($errors))
	{
		...
		$email_body = "This is an initiative to get the whole world drawing. ".	// this is the content of the email
		" <html>
		<head>
		...
		<br>
		<p>Image URL to Rijksstudio: <a href=\"\n $message\">click here</a></p>
	...
	// reply address
		...
		header('Location: http://draw-like-masters.elwebman.nl/image-form-thank-you.html');
	} 
	?>
